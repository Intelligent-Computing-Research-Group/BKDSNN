...
def Spikingformer_small(**kwargs):
    model = create_model(
        'Spikingformer',
        img_size_h=224, img_size_w=224,
...
#     ).cuda()
#
#     model_teacher = m.vit_base_patch16_224(num_classes=1000, pretrained=True).cuda()
#
#     # model.eval()
#     # model_teacher.eval()
#     # _, out = model(x, True)
#     # _, out_teacher = model_teacher(x, True)
#     # # print(y.shape)
#     # print(out[0].shape)
#     # print(out_teacher[0].shape)
#     # print('Test Good!')
#
#     state_dict = torch.load("../ckpt/checkpoint-306.pth.tar")["state_dict"]
