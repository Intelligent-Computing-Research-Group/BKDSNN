...
def main():
    ...
    # import model_ann
    # model = VisionTransformer(img_size=args.img_size, patch_size=args.patch_size,
    #                           embed_dim=args.dim, num_heads=args.num_heads, mlp_ratio=args.mlp_ratio,
    #                           in_chans=3, num_classes=args.num_classes, depth=args.depths, drop_rate=0., drop_path_rate=0.)

    model = timm.create_model("vit_small_patch16_224", pretrained=False, num_classes=args.num_classes, checkpoint_path="/root/.cache/torch/hub/checkpoints/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz")
    # model = create_model(
    #     'ANNTransformer',
    #     pretrained=False,
    #     drop_rate=0.,
