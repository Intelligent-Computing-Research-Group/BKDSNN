...
def main():
    ...
    parser.add_argument('-data_dir', type=str, default='/data/zkxu/cifar-10-dvs')
    ...
    parser.add_argument('--student_channel', default=256, type=int, metavar='SC',
                        help='student_emb')
    parser.add_argument('--alpha_mgd', default=7e-4, type=float, metavar='AM',
                        help='alpha_mgd')
    ...
    net_teacher.load_state_dict(torch.load("logs/best.pth", map_location="cpu")["model"])
